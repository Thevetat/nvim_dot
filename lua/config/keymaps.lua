...
-- lazygit
map("n", "<leader>gg", function() LazyVim.terminal.open({ "lazygit" }, { cwd = LazyVim.root.get() }) end, { desc = "Lazygit (root dir)" })
map("n", "<leader>gG", function() LazyVim.terminal.open({ "lazygit" }) end, { desc = "Lazygit (cwd)" })
